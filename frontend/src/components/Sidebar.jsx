...
//     { path: "/automation", icon: TrendingUp, label: "automation" }, // NEW
...
//             className="mb-4 flex items-center space-x-2 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white"
//           >
//             <X className="w-5 h-5" />
